        ...
        <div class="panel panel-primary">
            <div class="panel-heading panel-title text-center wow fadeInDown">
                <span style="font-weight:bold; font-family:verdana;"><i class="glyphicon glyphicon-list-alt"></i> Pets List</span>
            </div>
              	...
              	<thead>
					...
					if(mysqli_num_rows($result)>0){
                    	...
                    	<tr style="font-size:16px; cursor:pointer;">
                            ...
                            <td class="wow fadeInDown"> <center><strong><?php echo '₹'.$row['price'];?></strong></center></td>
