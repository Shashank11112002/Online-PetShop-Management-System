...
<head>
    ...
    <title>ADMIN | Online Petshop  Website</title>
            ...
            <div class="container">
                <div class="navbar-header">
                    <button type="button" class="navbar-toggle" data-toggle="collapse" data-target=".navbar-collapse">
                     ...
                     <a href="index.php"><h4 class="wow fadeInDown" style="margin-top:20px; color:#FFF;"><i class="fa fa-coffee"></i> Order Details</h4></a>
                </div>
    ...
    <div class="modal-content">
      ...
      <input type="hidden" name="fdid" value="<?php echo $row['id']?>">
        ...
        <dl class="dl-horizontal wow fadeInDown" style="text-align:left">
            ...
            <dt>Total:</dt> <dd><?php echo '₹'.number_format($total,2,'.',',');?></dd>
...
<!--*************************************************** FOOTERS **********************************************-->
    ...
    <footer id="footer" class="midnight-blue">
        <div class="container">
            <div class="row">
                <div class="col-sm-12">
                    <center>&copy; 2023 <a target="_blank" href="#" title="#">Online Pet Shop Management System</a>. All Rights Reserved Shash & Co.</center>
                </div>
            </div>
        </div>
    </footer><!--/#footer-->
