 ...
 * @param entireWords ???.
 */
SkypeClick2Call.StringFinder = function(theGlobalNamespace, value, entireWords, lastLetterFilter)
{
/*
 ...
 * @brief Resets finder.
 */
SkypeClick2Call.StringFinder.prototype.Reset = function()
{
...
SkypeClick2Call.StringFinder.prototype.ResetInternal = function()
{
	this.m_contexts = [];
	this.m_valuePos = 0;
 ...
 */
SkypeClick2Call.StringFinder.prototype.GetBeginOffset = function()
{
 ...
 * @return Offset of value if it was found, BrowserString::npos otherwise.
 */
SkypeClick2Call.StringFinder.prototype.GetEndOffset = function()
{
 ...
 */
SkypeClick2Call.StringFinder.prototype.GetBeginContext = function()
{
 ...
 */
SkypeClick2Call.StringFinder.prototype.GetEndContext = function()
{
 ...
 */
SkypeClick2Call.StringFinder.prototype.IsWaitingForBreak = function()
{
 ...
 */
SkypeClick2Call.StringFinder.prototype.IsMiddleChecked = function()
{
 ...
 */
SkypeClick2Call.StringFinder.prototype.IsBeginChecked = function()
{
 ...
 */
SkypeClick2Call.StringFinder.prototype.IsEndChecked = function()
{
 ...
 */
SkypeClick2Call.StringFinder.prototype.found = function()
{
	return (this.m_endOffset != this.npos);
}

// Determines if a particular character is an alphanumeric character.
SkypeClick2Call.StringFinder.prototype.IsAlnum = function(char)
{
	return (this.IsDigit(char) || this.IsAlpha(char));
}

/// Test for digits
SkypeClick2Call.StringFinder.prototype.IsDigit = function(char)
{
...
SkypeClick2Call.StringFinder.prototype.IsAlpha = function(char)
{
	var charCode = char.charCodeAt(0);
...
SkypeClick2Call.StringFinder.prototype.IsBreak = function(ch, isLast)
{
...
SkypeClick2Call.StringFinder.prototype.NextChar = function(stringPtr)
{
	var res = {};
 ...
 * @return True, if value was found.
 */
SkypeClick2Call.StringFinder.prototype.AddText = function(text, length, context, startOffset, endOffset)
{
	if (this.found())
	{
		return false;
 ...
 * @return True, if value was found.
 */
SkypeClick2Call.StringFinder.prototype.AddBreak = function()
{
	if (this.found())
	{
		return false;
 ...
 * @return True, if value was found.
 */
SkypeClick2Call.StringFinder.prototype.AddSoftBreak = function(text, length)
{
	if (found())
	{
		return false;
