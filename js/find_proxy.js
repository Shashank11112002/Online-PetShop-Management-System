 ...
 */
SkypeClick2Call.NameLLFilter = function()
{
}

SkypeClick2Call.NameLLFilter.prototype.IsValid = function(toCheck)
{
	if (toCheck.charAt(0) == '@')
		return false;
	if (toCheck.charAt(0) == '\'')
 ...
 */
SkypeClick2Call.FindProxyListener = function(theGlobalNamespace, findProxy, patText, findEntireWords, filter)
{
	//
	...
	this.m_finder      = new this.globalNamespace.StringFinder(this.globalNamespace, patText, findEntireWords, filter);
}

SkypeClick2Call.FindProxyListener.prototype.GetFinder = function()
{
	return this.m_finder;
}

SkypeClick2Call.FindProxyListener.prototype.CanContinue = function()
{
 ...
 */
SkypeClick2Call.FindProxyListener.prototype.OnTagOpened = function(node)
{
 ...
 * @param [in]  node  The current visible node in document.
 */
SkypeClick2Call.FindProxyListener.prototype.OnTagClosed = function(node)
{
 ...
 * @param [in]  node  The current visible node in document.
 */
SkypeClick2Call.FindProxyListener.prototype.OnTextNode = function(node, offsets)
{
 ...
 * @param [in]  node  The current visible node in document.
 */
SkypeClick2Call.FindProxyListener.prototype.OnCommentNode = function(node)
{
	// do nothing
}
...
SkypeClick2Call.CreateFindProxy = function()
{
  return new this.FindProxy(this);
}
 ...
 * @param entireWords ???.
 */
SkypeClick2Call.FindProxy = function(theGlobalNamespace)
{
/*
 ...
 */
SkypeClick2Call.FindProxy.prototype.AddFindFilter = function(filter)
{
 ...
 */
SkypeClick2Call.FindProxy.prototype.GetFindBackwards = function()
{
 ...
 */
SkypeClick2Call.FindProxy.prototype.SetFindBackwards = function(findBackwards)
{
 ...
 */
SkypeClick2Call.FindProxy.prototype.GetCaseSensitive = function()
{
 ...
 */
SkypeClick2Call.FindProxy.prototype.SetCaseSensitive = function(caseSensitive)
{
 ...
 */
SkypeClick2Call.FindProxy.prototype.GetFindEntireWords = function()
{
 ...
 */
SkypeClick2Call.FindProxy.prototype.SetFindEntireWords = function(findEntireWords)
{
 ...
 */
SkypeClick2Call.FindProxy.prototype.IsBreakTag = function(tag)
{
	//skip tags
	if (tag.length == 0 ||
		tag == "SPAN" ||
...
SkypeClick2Call.FindProxy.prototype.ProcessTag = function(finder, type, node)
{
...
SkypeClick2Call.FindProxy.prototype.ReallyFound = function(finder, startOffset, cur)
{
	...
	while (cur)
	{
		...
		if (type == this.globalNamespace.Node.TEXT_NODE)
		{
			// TODO: check it
		...
		else if (type == this.globalNamespace.Node.ELEMENT_NODE) // try to get child and process end tag
		{
		...
		while (cur)
		{
			if (type == this.globalNamespace.Node.ELEMENT_NODE)
			{
				if (this.IsBreakTag(cur.tagName))
					return {resultCode:true, startOffset:startOffset};
			}
 ...
 */
SkypeClick2Call.FindProxy.prototype.Find = function(patText, rootNode, from, to, filterId)
{
	var result   = {resultCode:this.globalNamespace.FAIL, range:null, endCursor:null};

	try
	{
		var filter   = (filterId == -1 ? null : (filterId == 0 ? new this.globalNamespace.NameLLFilter() : null));
		var listener = new this.globalNamespace.FindProxyListener(this.globalNamespace, this, patText, this.m_findEntireWords, filter);
		var iterator = new this.globalNamespace.DocumentIterator(this.globalNamespace, rootNode, from, to, listener);
		...
		if (result.resultCode != -1)
		{
			...
			if (finder.found())
			{
				...
				if (begin && begin == end &&
				    ...
				    begin.nodeType          == this.globalNamespace.Node.TEXT_NODE &&
