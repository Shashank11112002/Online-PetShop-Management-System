 ...
 *          But maybe in the future we will have to use them directly through the SkypeClick2Call.Node interface.
 */
...
// TBAR-2418 - JS on some web-pages delete global variables.
// So, we have to create a reference to our object and keep it in a safe place.
if (!window.__proto__.SkypeClick2Call)
{
	window.__proto__.SkypeClick2Call = window.SkypeClick2Call;
}

//
SkypeClick2Call.npos  = -1;

// global result constants
SkypeClick2Call.OK    = 0;
SkypeClick2Call.EMPTY = 1;
SkypeClick2Call.FAIL  = -1;
...
Element.prototype.setAttribute = function(name, val)
{
    ...
    e.initMutationEvent("SkypeClick2Call_DOMAttrModified", true, true, null, prev, val, name, (prev ? 1 : 2));
